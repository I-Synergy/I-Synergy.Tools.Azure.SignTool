...
using ISynergy.Tools.Azure.SignTool.Core.Abstractions.Stores;
using ISynergy.Tools.Azure.SignTool.Core.Configurations;
using ISynergy.Tools.Azure.SignTool.Core.Delegates;
using ISynergy.Tools.Azure.SignTool.Core.Enumerations;
using ISynergy.Tools.Azure.SignTool.Core.Factories;
using ISynergy.Tools.Azure.SignTool.Core.Interop;
...
public class CodeSigningService : ICodeSigningService
{
    ...
    /// <summary>
    /// Creates a new instance of <see cref="CodeSigningService" />.
    /// </summary>
    ...
    /// <param name="certificateStore">Optional certificate store. If not provided, a new in-memory store will be created.</param>
        ...
        ICertificateStore? certificateStore = null)
    {
        ...
        _certificateStore = certificateStore ?? MemoryCertificateStore.Create();
    ...
    /// <summary>
    /// Frees all resources used by the <see cref="CodeSigningService" />.
    /// </summary>
    public void Dispose()
    {
        _chain.Dispose();
